 ...
 * @version 1.0
 * @created_by longtran
 * @created_date 5/16/19 7:18 PM
 * @updated_by longtran
 * @updated_date 5/16/19 7:18 PM
 * @since 5/16/19
 */
@Configuration
@EnableSwagger2
public class SwaggerConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.kewdetect.integration.endpoint"))
                .paths(regex("/api.*"))
                .build()
                .apiInfo(metaData())
    ...
    public String getManifestBuildNumber() {
        String result = "Build #API-1.0.0-release-398a0145-cc27-44fa-81e7-094953066823, build on Wed Dec 21, 2018";
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("KewDetect Integration Service API")
                .description("KewDetect (@KewDetect)")
                .version(getManifestBuildNumber())
                .license("Apache License Version 2.0")
                .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0\"")
                .contact(new Contact("Contact the developer", "/about/", "KewDetect"))
                .build();
    }
